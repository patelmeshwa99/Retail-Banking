...
<%@ include file="header.jsp" %>
    ...
    <form action="http://localhost:8889/RetailBankManagement/Accountstmt1" method="get">
        Account ID : <input type="text name="accountid" pattern="[0-9]{9}" required="required" placeholder="enter your 9 digit account no."> 
          <br>
          <br>
          ...
          <br>
          <br>
          Number of Transactions: &nbsp;&nbsp; <input type="number" name="noftransaction" style="width: 50px;">
          <br>
          <br>
        </div>
